  ...
  return (
    <div className="min-h-screen gradient-black-red bg-gray-950">
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        {/* Body Detection Camera - Interactive Demo */}
        <section className="mb-16">
          <div className="container mx-auto px-4">
            <div className="text-center mb-8">
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
                Try Body Detection Now
              </h2>
              <p className="text-lg text-gray-300 max-w-2xl mx-auto">
                Experience real-time body detection with our interactive camera. 
                The detection method only activates when you click "Start Body Detection" to capture and analyze your body pose.
              </p>
            </div>
        ...
        {/* Voice Chat Bot - Python Integration */}
        <section className="mb-16">
          <div className="container mx-auto px-4">
            <VoiceChatBot />
          </div>
